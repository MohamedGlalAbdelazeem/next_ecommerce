  ...
  return user && (
    ...
    <div className="flex  justify-center">
      ...
      <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
        ...
        <li>
          <a className="text-gray-300  transition hover:text-gray-700/75" href="#"> تواصل معنا </a>
        </li>
  
        <li>
          <a className="text-gray-300 transition hover:text-gray-700/75" href="#"> عملاؤنا  </a>
        </li>
  
        <li>
          <a className="text-gray-300  transition hover:text-gray-700/75" href="#"> خدماتنا </a>
        </li>
  
        <li>
          <a className="text-gray-300  transition hover:text-gray-700/75" href="#"> دعم فني  </a>
        </li>
  
        <li>
          <a className="text-gray-300 transition hover:text-gray-700/75" href="#"> منتجاتنا الرقمية  </a>
        </li>
      </ul>
